...
```bash
python3 ".cursor/skills/swiftui-ios-expert/scripts/analyze_trace.py" \
...
```bash
python3 ".cursor/skills/swiftui-ios-expert/scripts/analyze_trace.py" --trace <path> --list-logs \
...
```bash
python3 ".cursor/skills/swiftui-ios-expert/scripts/analyze_trace.py" --trace <path> --list-signposts \
...
```bash
python3 ".cursor/skills/swiftui-ios-expert/scripts/analyze_trace.py" --trace <path> \
