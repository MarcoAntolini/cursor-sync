...
The day-to-day loop: plan, tracer bullet, increment, refactor.
...
Never fix bugs without a test. For hard bugs that need investigation first, hand off to the [`diagnose`](../../diagnose/SKILL.md) skill — it'll come back to TDD once a feedback loop exists.
