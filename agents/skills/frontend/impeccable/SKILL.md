---
name: impeccable
description: Default skill for app UI, dashboards, product surfaces, app shells, components, forms, settings, onboarding, and empty states — design, redesign, shape, critique, audit, polish, clarify, distill, harden, optimize, adapt, animate, colorize, extract, or iterate. Prefer design-taste-frontend for marketing landings and portfolios. Handles UX review, visual hierarchy, information architecture, cognitive load, accessibility, performance, responsive behavior, theming, anti-patterns, typography, spacing, layout, color, motion, micro-interactions, UX copy, error states, edge cases, i18n, and design tokens. Also use for bland designs that need to become bolder, loud designs that should become quieter, live browser iteration, or ambitious visual effects. Not for backend-only or non-UI tasks.
version: 3.9.1
---
