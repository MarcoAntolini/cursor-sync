---
name: ui-ux-pro-max
description: "Opt-in only — invoke by name when you want a lookup from the local UI/UX reference database (styles, palettes, fonts, product types, UX guidelines, icons, GSAP presets, charts). Do not auto-use for ordinary UI design or review; prefer impeccable, design-taste-frontend, or web-design-guidelines."
